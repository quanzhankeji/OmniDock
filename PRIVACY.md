...
OmniDock is a local macOS utility for Dock window previews, Dock click window toggling, and per-app keyboard shortcuts. OmniDock is currently distributed as source code only. This policy explains what data the app handles and how it is used.
